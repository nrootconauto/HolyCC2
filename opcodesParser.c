...
void parseOpcodeFile() {
	const char *keywords[] = {
	    ...
	    ",",    "+R", "+I",     "/R",     "/0",      "/1",      "/2", "/3", "/4", "/5",   "/6",    "/7",    "IB", "IW",  "ID",  "RM8", "RM16", "RM32", "RM64", "R8", "R16", "R32", "R64", "16", "32", "64", "IMM8", "IMM16", "IMM32", "IMM64", "UIMM8", "UIMM16", "UIMM32", "UIMM64", "OPCODE",
		...
		template.args = strOpcodeTemplateArgAppendItem(template.args, __arg);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
							...
							if (item->type == LEXER_INT) {
								...
								if (0 == strcmp(item->value.kw, ";")) {
									...
									template.modRMReg = 1;
								} else if (0 == strcmp(item->value.kw, "/0") || 0 == strcmp(item->value.kw, "/1") || 0 == strcmp(item->value.kw, "/2") || 0 == strcmp(item->value.kw, "/3") || 0 == strcmp(item->value.kw, "/4") || 0 == strcmp(item->value.kw, "/5") || 0 == strcmp(item->value.kw, "/6") || 0 == strcmp(item->value.kw, "/7")) {
