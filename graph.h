...
#define GRAPH_TYPE_FUNCS(type, edgeType, suffix)                                                                                                                   \
	...
	inline void graphNode##suffix##KillGraph(graphNode##suffix *node, void (*killNode)(void *), void (*killEdge)(void *)) __attribute__((always_inline));            \
	inline void graphNode##suffix##KillGraph(graphNode##suffix *node, void (*killNode)(void *), void (*killEdge)(void *)) {                                          \
		__graphKillAll((graphNode##suffix) * node, killNode, killEdge);                                                                                                \
	}                                                                                                                                                                \
	inline void graphNode##suffix##Kill(graphNode##suffix *node, void (*killNode)(void *), void (*killEdge)(void *)) __attribute__((always_inline));                 \
	inline void graphNode##suffix##Kill(graphNode##suffix *node, void (*killNode)(void *), void (*killEdge)(void *)) {                                               \
		__graphNodeKill((graphNode##suffix) * node, killNode, killEdge);                                                                                               \
	}                                                                                                                                                                \
	inline void graphEdge##suffix##Kill(graphNode##suffix node, graphNode##suffix node2, void *data, int (*pred)(void *, void *), void (*killEdge)(void *))          \
	    __attribute__((always_inline));                                                                                                                              \
	inline void graphEdge##suffix##Kill(graphNode##suffix node, graphNode##suffix node2, void *data, int (*pred)(void *, void *), void (*killEdge)(void *)) {        \
		return __graphEdgeKill((graphNode##suffix)node, (graphNode##suffix)node2, data, pred, killEdge);                                                               \
	}                                                                                                                                                                \
	inline void graphNode##suffix##VisitForward(graphNode##suffix node, void *data,                                                                                  \
	                                            int (*pred)(const struct __graphNode *, const struct __graphEdge *, const void *),                                   \
	                                            void (*visit)(struct __graphNode *, void *)) __attribute__((always_inline));                                         \
	inline void graphNode##suffix##VisitForward(graphNode##suffix node, void *data,                                                                                  \
	                                            int (*pred)(const struct __graphNode *, const struct __graphEdge *, const void *),                                   \
	                                            void (*visit)(struct __graphNode *, void *)) {                                                                       \
		__graphNodeVisitForward((struct __graphNode *)node, data, pred, visit);                                                                                        \
	}                                                                                                                                                                \
	inline void graphNode##suffix##VisitBackward(graphNode##suffix node, void *data,                                                                                 \
	                                             int(pred)(const struct __graphNode *, const struct __graphEdge *, const void *),                                    \
	                                             void (*visit)(struct __graphNode *, void *)) __attribute__((always_inline));                                        \
	inline void graphNode##suffix##VisitBackward(graphNode##suffix node, void *data,                                                                                 \
	                                             int(pred)(const struct __graphNode *, const struct __graphEdge *, const void *),                                    \
	...
	inline graphNode##suffix graphNode##suffix##Create(type value, int version) __attribute__((always_inline));                                                      \
	inline graphNode##suffix graphNode##suffix##Create(type value, int version) {                                                                                    \
		return (graphNode##suffix)__graphNodeCreate(&value, sizeof(type), version);                                                                                    \
	}                                                                                                                                                                \
	inline void graphNode##suffix##ReadLock(graphNode##suffix node) __attribute__((always_inline));                                                                  \
	inline void graphNode##suffix##ReadLock(graphNode##suffix node) {                                                                                                \
		__graphNodeReadLock(node);                                                                                                                                     \
	}                                                                                                                                                                \
	inline void graphNode##suffix##ReadUnlock(graphNode##suffix node) __attribute__((always_inline));                                                                \
	inline void graphNode##suffix##ReadUnlock(graphNode##suffix node) {                                                                                              \
		__graphNodeReadUnlock(node);                                                                                                                                   \
	}                                                                                                                                                                \
	inline void graphNode##suffix##WriteLock(graphNode##suffix node) __attribute__((always_inline));                                                                 \
	inline void graphNode##suffix##WriteLock(graphNode##suffix node) {                                                                                               \
		__graphNodeWriteLock(node);                                                                                                                                    \
	}                                                                                                                                                                \
	inline void graphNode##suffix##WriteUnlock(graphNode##suffix node) __attribute__((always_inline));                                                               \
	inline void graphNode##suffix##WriteUnlock(graphNode##suffix node) {                                                                                             \
		__graphNodeWriteUnlock(node);                                                                                                                                  \
	}                                                                                                                                                                \
	inline graphEdge##suffix graphNode##suffix##Connect(graphNode##suffix node, graphNode##suffix node2, edgeType value) __attribute__((always_inline));             \
	inline graphEdge##suffix graphNode##suffix##Connect(graphNode##suffix node, graphNode##suffix node2, edgeType value) {                                           \
		return __graphNodeConnect(node, node2, &value, sizeof(edgeType));                                                                                              \
	}                                                                                                                                                                \
	inline str##GraphEdge##suffix##P graphNode##suffix##Incoming(graphNode##suffix node) __attribute__((always_inline));                                             \
	inline str##GraphEdge##suffix##P graphNode##suffix##Incoming(graphNode##suffix node) {                                                                           \
		return (str##GraphEdge##suffix##P)__graphNodeIncoming(node);                                                                                                   \
	}                                                                                                                                                                \
	inline str##GraphEdge##suffix##P graphNode##suffix##Outgoing(graphNode##suffix node) __attribute__((always_inline));                                             \
	inline str##GraphEdge##suffix##P graphNode##suffix##Outgoing(graphNode##suffix node) {                                                                           \
		return (str##GraphEdge##suffix##P)__graphNodeOutgoing(node);                                                                                                   \
	}                                                                                                                                                                \
	inline edgeType *graphEdge##suffix##ValuePtr(const graphEdge##suffix edge) __attribute__((always_inline));                                                       \
	inline edgeType *graphEdge##suffix##ValuePtr(const graphEdge##suffix edge) {                                                                                     \
		return __graphEdgeValuePtr(edge);                                                                                                                              \
	}                                                                                                                                                                \
	inline graphNode##suffix graphEdge##suffix##Outgoing(const graphEdge##suffix edge) __attribute__((always_inline));                                               \
	inline graphNode##suffix graphEdge##suffix##Outgoing(const graphEdge##suffix edge) {                                                                             \
		return __graphEdgeOutgoing(edge);                                                                                                                              \
	}                                                                                                                                                                \
	inline graphNode##suffix graphEdge##suffix##Incoming(const graphEdge##suffix edge) __attribute__((always_inline));                                               \
	inline graphNode##suffix graphEdge##suffix##Incoming(const graphEdge##suffix edge) {                                                                             \
		return __graphEdgeIncoming(edge);                                                                                                                              \
	}                                                                                                                                                                \
	inline type *graphNode##suffix##ValuePtr(const graphNode##suffix edge) __attribute__((always_inline));                                                           \
	inline type *graphNode##suffix##ValuePtr(const graphNode##suffix edge) {                                                                                         \
		return __graphNodeValuePtr(edge);                                                                                                                              \
	}                                                                                                                                                                \
	inline int graphNode##suffix##ConnectedTo(const graphNode##suffix from, const graphNode##suffix to) __attribute__((always_inline));                              \
	inline int graphNode##suffix##ConnectedTo(const graphNode##suffix from, const graphNode##suffix to) {                                                            \
	...
	inline strGraphNode##suffix##P graphNode##suffix##OutgoingNodes(const graphNode##suffix node) {                                                                  \
	...
	inline strGraphNode##suffix##P graphNode##suffix##IncomingNodes(const graphNode##suffix node) {                                                                  \
	...
	inline strGraphNode##suffix##P graphNode##suffix##AllNodes(const graphNode##suffix node) {                                                                       \
