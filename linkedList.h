...
#define LL_TYPE_FUNCS(type, suffix)                                                                                                                                \
	inline ll##suffix ll##suffix##Create(type value) __attribute__((always_inline));                                                                                 \
	...
	inline ll##suffix ll##suffix##Empty() {                                                                                                                          \
		return NULL;                                                                                                                                                   \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##Insert(ll##suffix from, ll##suffix toInsert, int (*pred)(const type *, const type *)) __attribute__((always_inline));              \
	inline ll##suffix ll##suffix##Insert(ll##suffix from, ll##suffix toInsert, int (*pred)(const type *, const type *)) {                                            \
		return (ll##suffix){__llInsert(from, toInsert, (int (*)(const void *, const void *))pred)};                                                                    \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##Remove(ll##suffix from) __attribute__((always_inline));                                                                            \
	inline ll##suffix ll##suffix##Remove(ll##suffix from) {                                                                                                          \
		return (ll##suffix)__llRemoveNode(from);                                                                                                                       \
	}                                                                                                                                                                \
	inline type *ll##suffix##ValuePtr(const ll##suffix Node) __attribute__((always_inline));                                                                         \
	inline type *ll##suffix##ValuePtr(const ll##suffix Node) {                                                                                                       \
		return (type *)__llValuePtr(Node);                                                                                                                             \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##Next(const ll##suffix Node) __attribute__((always_inline));                                                                        \
	inline ll##suffix ll##suffix##Next(const ll##suffix Node) {                                                                                                      \
		return (ll##suffix)__llNext(Node);                                                                                                                             \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##Prev(const ll##suffix Node) __attribute__((always_inline));                                                                        \
	inline ll##suffix ll##suffix##Prev(const ll##suffix Node) {                                                                                                      \
		return (ll##suffix)__llPrev(Node);                                                                                                                             \
	}                                                                                                                                                                \
	inline void ll##suffix##Destroy(ll##suffix *node, void (*killFunc)(void *)) __attribute__((always_inline));                                                      \
	inline void ll##suffix##Destroy(ll##suffix *node, void (*killFunc)(void *)) {                                                                                    \
		__llDestroy(*node, killFunc);                                                                                                                                  \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##FindLeft(const ll##suffix node, const void *data, int (*pred)(const void *, const type *)) __attribute__((always_inline));         \
	inline ll##suffix ll##suffix##FindLeft(const ll##suffix node, const void *data, int (*pred)(const void *, const type *)) {                                       \
		return (ll##suffix)__llFindLeft(node, data, (int (*)(const void *, const void *))pred);                                                                        \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##FindRight(const ll##suffix node, const void *data, int (*pred)(const void *, const type *)) __attribute__((always_inline));        \
	inline ll##suffix ll##suffix##FindRight(const ll##suffix node, const void *data, int (*pred)(const void *, const type *)) {                                      \
		return (ll##suffix)__llFindRight(node, data, (int (*)(const void *, const void *))pred);                                                                       \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##First(const ll##suffix node) __attribute__((always_inline));                                                                       \
	inline ll##suffix ll##suffix##First(const ll##suffix node) {                                                                                                     \
		return (ll##suffix)__llGetFirst(node);                                                                                                                         \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##Last(const ll##suffix node) __attribute__((always_inline));                                                                        \
	inline ll##suffix ll##suffix##Last(const ll##suffix node) {                                                                                                      \
		return (ll##suffix)__llGetEnd(node);                                                                                                                           \
	}                                                                                                                                                                \
	inline long ll##suffix##Size(const ll##suffix node) __attribute__((always_inline));                                                                              \
	inline long ll##suffix##Size(const ll##suffix node) {                                                                                                            \
		return __llSize(node);                                                                                                                                         \
	}                                                                                                                                                                \
	inline void ll##suffix##InsertListBefore(ll##suffix node, ll##suffix item) __attribute__((always_inline));                                                       \
	inline void ll##suffix##InsertListBefore(ll##suffix node, ll##suffix item) {                                                                                     \
		llInsertListBefore(node, item);                                                                                                                                \
	}                                                                                                                                                                \
	inline void ll##suffix##InsertListAfter(ll##suffix node, ll##suffix item) __attribute__((always_inline));                                                        \
	inline void ll##suffix##InsertListAfter(ll##suffix node, ll##suffix item) {                                                                                      \
		llInsertListAfter(node, item);                                                                                                                                 \
	}                                                                                                                                                                \
	inline ll##suffix ll##suffix##Find(const ll##suffix node, const void *data, int (*pred)(const void *, const type *)) __attribute__((always_inline));             \
	inline ll##suffix ll##suffix##Find(const ll##suffix node, const void *data, int (*pred)(const void *, const type *)) {                                           \
